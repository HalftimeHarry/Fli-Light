<script lang="ts">
	...
	export let sponsorName: string = ''; // You can also use this to show which venue the sponsor is associated with
</script>
...
<div class="border border-gray-300 rounded p-4 transition-shadow hover:shadow-md flex items-center">
	...
	<div>
		...
		<div class="text-gray-400">Sponsor of: {sponsorName}</div>
	</div>
</div>
